...
export type LastSend = {
  address: "FdTcqYRk8nyNYjiV62nvR2ybMsU7j5tWctvvTZVhTjbL";
  metadata: {
    name: "lastSend";
    version: "0.1.0";
    spec: "0.1.0";
      ...
      accounts: [
        {
          ...
          pda: {
            seeds: [
              {
                kind: "const";
                value: [71, 76, 79, 66, 65, 76, 95, 83, 84, 65, 84, 69];
              }
            ];
          };
        },
        ...
        },
        {
          ...
          pda: {
            seeds: [
              {
                kind: "const";
                value: [71, 65, 77, 69, 95, 83, 84, 65, 84, 69];
              },
              {
                kind: "account";
                path: "global_state.current_game_index";
  ...
  events: [
    ...
    {
      name: "stakeSolEvent";
      discriminator: [10, 44, 142, 57, 77, 57, 25, 134];
    }
  ];
  errors: [
    {
